...
export const Gallery = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 mt-20 mb-8  bg-[url('https://images.unsplash.com/photo-1595514535215-8a093483610a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')] h-[1240px] md:h-[640px] tablet:h-[710px]  ">
